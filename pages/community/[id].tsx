...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      <span className="my-3 ml-4 inline-flex items-center rounded-full bg-orange-500 px-2.5 py-0.5 text-xs font-medium text-white">
        동네질문
      </span>
      ...
      <div>
        ...
        <div className="mt-3 flex w-full space-x-5 border-[1px] px-4 py-2.5  text-gray-700">
