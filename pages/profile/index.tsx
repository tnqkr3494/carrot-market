    ...
    <div className="px-4 py-10">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex flex-col">
          <span className="text-md font-medium text-gray-900">Steve Jebs</span>
          <span className="font-sm text-sm text-gray-500">
            Edit profile &rarr;
          </span>
        </div>
      </div>
      <div className="mt-8 flex items-center justify-around border-y-2 py-4">
        <div className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm text-gray-600">판매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-white">
            <svg
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="mt-2 text-sm text-gray-600">관심목록</span>
        </div>
      </div>
      <div>
